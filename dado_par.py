...
# Caso uesemos as duas variaveis X ou Y podemos usar o union()
#pares = set(x for x in range(1, 7) if x % 2 == 0 or x > 4)
#maiores =set(y for y in range(1, 7) if y > 4)
#Prob = len(pares.union(maiores))/6
#print(prob)
